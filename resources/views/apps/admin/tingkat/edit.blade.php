        ...
        <div class="card">
          <div class="card-header">
            <div class="row align-items-center">
              <div class="col-8">
                <h3 class="mb-0">Edit Tingkat</h3>
              </div>
            </div>
          </div>
          <div class="card-body">
            <form method="POST" action="{{ route('admin.tingkat.update') }}">
                @csrf @method('PUT')
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        ...
                        <input type="text" id="name" name="nama" class="form-control" value="{{ old('nama', $tingkat->nama) }}">
                        </div>
                    </div>
                </div>
                <div class="row">  
